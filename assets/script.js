...
function initLS() {
  var dataFromLS = JSON.parse(localStorage.getItem("workdayData"));
...
$(".saveBtn").on("click", function (event) {
  ...
  var schedule = JSON.parse(localStorage.getItem("workdayData"));
  var scheduleToSave = {
    ...schedule,
    [timeBlockTime]: timeBlockValue,
  };
  localStorage.setItem("workdayData", JSON.stringify(scheduleToSave));
});
